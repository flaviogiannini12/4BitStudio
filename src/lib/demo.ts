...
export const demoData: StudioData = {
  ...
  recurrences: [
    { id: 'r-oxy', clientId: 'c-oxymoro', label: 'Mantenimento sito', amount: 75, intervalMonths: 3, dueDay: null, nextDueDate: iso(8), active: true, notes: 'Trimestrale', createdAt: iso(-300) },
    { id: 'r-demo-monthly', clientId: 'c-trattoria', label: 'Servizio mensile', amount: 250, intervalMonths: 1, dueDay: null, nextDueDate: iso(3), active: true, notes: '', createdAt: iso(-90) },
  ],
  ledgerEntries: [],
  compensations: [],
  deadlines: [],
  maintenancePeriods: [],
  payments: [
    { id: 'pay-uar', clientId: 'c-uar', projectId: 'p-uar', recurrenceId: null, label: 'Saldo sito web', amount: 500, dueDate: iso(-2), status: 'pending', paidAt: null, reminderCount: 0, lastReminderAt: null, notes: 'Da sollecitare', createdAt: iso(-20) },
    { id: 'pay-oxy', clientId: 'c-oxymoro', projectId: null, recurrenceId: 'r-oxy', label: 'Mantenimento sito', amount: 75, dueDate: iso(8), status: 'pending', paidAt: null, reminderCount: 0, lastReminderAt: null, notes: '', createdAt: iso(-10) },
    { id: 'pay-monthly', clientId: 'c-trattoria', projectId: null, recurrenceId: 'r-demo-monthly', label: 'Servizio mensile', amount: 250, dueDate: iso(3), status: 'pending', paidAt: null, reminderCount: 0, lastReminderAt: null, notes: '', createdAt: iso(-8) },
  ],
}
